...
namespace Framework.Infrastructure.Crosscutting
{
    /// <summary>
    /// 检查器
    /// </summary>
    public static class Check
    {
        ...
        public static class Argument
        {
            ...
            public static void IsNotNullOrEmpty(string argument, string argumentName)
            {
                ...
                {
                    throw new ArgumentException(string.Format("ArgumentCannotBeNullOrEmptyString", argumentName), argumentName);
                }
            }
            ...
            public static void IsNotNullOrEmpty(byte[] argument, string argumentName)
            {
                ...
                {
                    throw new ArgumentException(string.Format("ArgumentCannotBeNullOrEmptyArray", argumentName), argumentName);
                }
            }
            ...
            public static void IsNotNullOrEmpty<T>(IList<T> argument, string argumentName)
            {
                ...
                {
                    throw new ArgumentException(string.Format("ArgumentCannotBeNullOrEmptyCollection", argumentName), argumentName);
                }
            }
            ...
            public static void IsNotNull(object argument, string argumentName)
            {
                if (argument == null)
                {
                    throw new ArgumentException(string.Format("ArgumentCannotBeNull", argumentName), argumentName);
                }
            }
            ...
            public static void IsInRange(int argument, string argumentName, int min, int max)
            {
                ...
                {
                    throw new ArgumentOutOfRangeException(argumentName, string.Format("ArgumentCannotBeNull", argumentName, min, max));
                }
            }
