...
namespace Framework.Infrastructure.Crosscutting.Extensions
{
    /// <summary>
    /// 字符串常用的一些扩展方法
    /// </summary>
    public static class StringExtension
    {
        ...
        #region 字符串单词 单数/复数 变化

        /// <summary> 
        /// 将英文词（参数：<paramref name="word"/>） 复数化
        /// 如 Order -> Orders,  Child -> Children
        /// </summary>
        /// <param name="word">需要被复数化的词</param>
        /// <param name="inputIsKnownToBeSingular">是否确定输入的字符串是一个单数的单词</param>
        /// <returns>复数化后的词</returns>
        ...
        /// <summary>
        /// 将英文词（参数：<paramref name="word"/>）单数化
        /// 如 Products -> Product
        /// </summary>
        /// <param name="word">需要被单数化的词</param>
        /// <param name="inputIsKnownToBePlural">是否确定输入的字符串是一个复数的单词</param>
        /// <returns>单数化后的词</returns>
